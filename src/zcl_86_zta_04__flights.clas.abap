CLASS zcl_86_zta_04__flights DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_86_zta_04__flights IMPLEMENTATION.
...
*Add 50 new connection numbers and 2000 days of flights for each
    ...
    INSERT zta_04_flights FROM TABLE @insert_tab.
    out->write( |Generated { sy-dbcnt } rows in table ZTA_04_FLIGHTS| ).
