CLASS zcl_28_structured_types DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_28_structured_types IMPLEMENTATION.
...
**********************************************************************
    ...
    SELECT SINGLE
      FROM /DMO/I_Connection
    FIELDS DepartureAirport, DestinationAirport, \_Airline-Name "\_ FOR ADD FIELDS ASSOCIATION
     WHERE AirlineID = 'LH'
       AND ConnectionID = '0400'
      INTO @connection.
