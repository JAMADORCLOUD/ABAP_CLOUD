...
PRIVATE SECTION.
DATA connections TYPE SORTED TABLE OF zta_04_flights WITH NON-UNIQUE KEY carrier_id connection_Id flight_date.
DATA connections_sk TYPE SORTED TABLE OF zta_04_flights WITH NON-UNIQUE KEY carrier_id connection_id flight_date
...
SELECT FROM zta_04_flights FIELDS * INTO TABLE @connections.
SELECT FROM zta_04_flights FIELDS * INTO TABLE @connections_sk.
