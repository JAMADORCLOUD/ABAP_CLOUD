...
* wrong:
*    DATA carrier_id_aux    TYPE /dmo/connection_id    READ-ONLY.
*    DATA connection_id_aux TYPE /dmo/carrier_id       READ-ONLY.
*    DATA connection_id_aux TYPE char4                 READ-ONLY.
* correct:
    DATA carrier_id_aux    TYPE /dmo/carrier_id       READ-ONLY.
    DATA connection_id_aux TYPE /dmo/connection_id    READ-ONLY.
...
TRY.
    me->carrier_id_aux = EXACT #( carrier_id ).
  CATCH cx_sy_conversion_error.
    CLEAR me->carrier_id_aux.
ENDTRY.


TRY.
    connection_id_aux = EXACT #( connection_id ).
  CATCH cx_sy_conversion_error.
    CLEAR connection_id_aux.
ENDTRY.
